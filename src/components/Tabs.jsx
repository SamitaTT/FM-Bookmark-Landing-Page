  ...
  return (
    <div className={`${darkMode && "dark"}`}>
      <div className="w-full flex flex-col mb-40 items-center">
        <div
          className="flex flex-col 2xl:flex-row text-grayish-blue 2xl:text-xl 2xl:h-20 2xl:w-[50rem] 2xl:gap-0 text-lg w-[20rem] gap-5 justify-evenly
         dark:text-dark-grayish-blue md:w-[32rem]"
        >
          {FeatureData.map((tab) => {
            return (
              <button
            ...
            <div key={tab.id}>
              {activeTab === tab.id && (
                <div className="flex 2xl:flex-row flex-col justify-center 2xl:gap-40 gap-16 mt-20 items-center ">
                  <img
                    src={tab.img}
                    className="relative z-10 2xl:w-[38rem] w-[21rem] 2xl:left-none md:w-[32rem]"
                  ></img>
                  <div
                  ...
                  <div className="flex flex-col 2xl:w-[500px] 2xl:h-[390px] justify-center w-full items-center 2xl:items-start">
                    ...
                    md:text-lg md:leading-9 md:w-[480px]"
                    >
                      {tab.content}
                    </p>
