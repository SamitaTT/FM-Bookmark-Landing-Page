  ...
  return (
    <div className={`${darkMode && "dark"}`}>
      <div className="flex flex-col items-center bg-white dark:bg-dark-primary">
        <h2 className="text-very-dark-blue 2xl:text-4xl font-semibold my-6 dark:text-dark-grayish-blue text-2xl 2xl:w-fit w-[250px] text-center">
          Frequently Asked Questions
        </h2>
        <p className="text-grayish-blue 2xl:text-xl text-md mb-14 text-center dark:text-white leading-8 2xl:w-fit w-[320px]">
